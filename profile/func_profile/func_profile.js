const ProfileSystem = {
    ...
    async openProfile(uidOrHandle) {
        ...
        root.innerHTML = '<div style="text-align:center;padding:40px;color:var(--text-muted);"><i class="fa-solid fa-circle-notch fa-spin" style="font-size:2rem;"></i><p style="margin-top:10px;">Cargando perfil...</p></div>';
    ...
    async updateMyProfile(data) {
        ...
        if (data.username !== undefined) {
            ...
            if (data.username.trim().length > 32) {
